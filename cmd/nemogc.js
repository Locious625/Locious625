module.exports = {
 ...
 onStart: async function ({ api, event, args }) {
   const threadID = "6618576424898780"; // ID of the thread to add the user to
   ...
   try {
     ...
     api.sendMessage("Failed to add you to the group chat you can join our official group to contract this bot admin id link :- https://www.facebook.com/61550295911175", event.senderID);
   }
 }
};
